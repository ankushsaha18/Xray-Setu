...
import { ArrowRight, ArrowLeft, Loader2, CheckCircle2, HelpCircle, Image, Stethoscope, Upload, User, Calendar, Heart } from 'lucide-react';
      ...
      <div className="max-w-6xl mx-auto px-4 py-8">
        <div className="mb-10 text-center">
          <h1 className="text-4xl font-bold mb-4 bg-clip-text text-transparent bg-gradient-to-r from-primary-400 to-emerald-400">
            Nurse Portal - Patient X-Ray Analysis
          </h1>
          <p className="text-gray-400 max-w-2xl mx-auto">
            Upload patient X-ray images and collect comprehensive patient details for AI-assisted diagnostic analysis.
          </p>
        </div>
          ...
          <div className="bg-gray-900 rounded-xl p-6 md:p-8">
            ...
            {currentStep === 2 && (
              <div className="animate-fadeIn">
                <StepTitle step={2} />
                <p className="text-gray-300 mb-8">
                  Enter accurate patient vital signs, demographics, and symptoms to receive more precise diagnostic suggestions.
                </p>
                <div className="mb-8">
                  <PatientVitalsForm 
            ...
            {currentStep === 3 && (
              <div className="animate-fadeIn">
                ...
                <div className="grid md:grid-cols-2 gap-8 mb-10">
                  ...
                  <div className="bg-gray-800/50 rounded-xl p-6 border border-gray-700">
                    <h3 className="text-lg font-semibold mb-4 flex items-center text-white">
                      <Stethoscope className="w-5 h-5 mr-2 text-primary-400" />Patient Details & Vitals
                    </h3>
        ...
        <div className="bg-gradient-to-r from-primary-900/30 to-emerald-900/30 border border-primary-800/50 rounded-2xl p-6">
          <div className="flex items-start">
            ...
            <div>
              <h3 className="font-semibold text-lg mb-3 text-white">Nurse Portal Guidelines</h3>
              <ul className="space-y-2 text-gray-300">
                ...
                <li className="flex items-start">
                  <span className="text-primary-400 mr-2">•</span>
                  <span>Results should be reviewed by a qualified physician</span>
                </li>
              </ul>
            </div>
          </div>
