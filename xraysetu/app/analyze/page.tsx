              ...
              <div className="animate-fadeIn">
                ...
                <div className="mb-6">
                  ...
                  <div className="max-w-xs relative">
                    <select 
                      className="w-full p-3 bg-gray-800 border border-gray-700 rounded-xl focus:ring-2 focus:ring-primary-500 focus:outline-none text-white appearance-none cursor-pointer transition-all hover:bg-gray-750"
                      defaultValue="en"
