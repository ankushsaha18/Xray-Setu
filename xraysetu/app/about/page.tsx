  ...
  return (
    <div className="max-w-5xl mx-auto px-4 py-12">
      <div className="text-center mb-12">
        <h1 className="text-3xl md:text-4xl font-bold mb-4">About Xray Setu</h1>
      ...
      <div className="mb-12">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-md p-6 mb-6">
          <p className="text-gray-700 dark:text-gray-300 mb-4">
            Xray Setu aims to improve diagnostic accuracy, reduce interpretation time, and enhance patient care by providing radiologists and clinicians with AI-powered assistance for chest X-ray analysis.
          </p>
