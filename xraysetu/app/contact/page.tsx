    ...
    <div className="max-w-5xl mx-auto px-4 py-12">
      <div className="text-center mb-12">
        ...
        <p className="text-lg text-gray-600 dark:text-gray-400 max-w-3xl mx-auto">
          Have questions about our Xray Setu system? Reach out to our team for support, feedback, or collaboration opportunities.
        </p>
      </div>
            ...
            <ul className="space-y-6">
              ...
              <li className="flex items-start">
                ...
                <div>
                  ...
                  <a 
                    href="https://github.com/MMansy19/xray-setu-app" 
                    target="_blank" 
                    rel="noopener noreferrer" 
                    className="text-gray-600 dark:text-gray-400 hover:text-blue-600 dark:hover:text-blue-400 transition-colors"
                  >
                    github.com/MMansy19/xray-setu-app
                  </a>
                </div>
              </li>
            </ul>
      ...
      <div className="mt-12">
        <div className="bg-blue-50 dark:bg-blue-900/20 rounded-xl p-6 border border-blue-100 dark:border-blue-800">
          ...
          <p className="text-gray-700 dark:text-gray-300">
            Please contact us at <a href="mailto:partnerships@xray-setu.example" className="text-blue-600 dark:text-blue-400 hover:underline">partnerships@xray-setu.example</a> with details about your organization and interests.
          </p>
